        ...
        <div class="container">
            <div class="flex">
                <div class="col-lg-3 ">
                    ...
                    <img src=" image/L-enfant-parfaite.jpg" class="card-img-top" alt="...">
                ...
                <div class="col-lg-3">
                    <div class="card cardHome">
                        <img src="image/Belle-Greene.jpg" class="card-img-top" alt="...">
                        <div class="card-body cardBorderHome">
                ...
                <div class="col-lg-3 ">
                    <div class="card cardHome">
                        <img src="image/Des-diables-et-des-saints.jpg" class="card-img-top" alt="...">
                        <div class="card-body cardBorderHome">
                            <h5 class="card-title flex">Card title</h5>
                        </div>
                    </div>
            ...
            <div class="flex ">
                <div class="col-lg-3 ">
                    <div class="card cardHome">
                        <img src="image/Le-paeur.jpg" class="card-img-top" alt="...">
                        <div class="card-body cardBorderHome">
                            <h5 class="card-title flex">Card title</h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 ">
                    <div class="card cardHome">
                        <img src="image/Les-Vilaines.jpg" class="card-img-top" alt="...">
                        <div class="card-body cardBorderHome">
                            <h5 class="card-title flex">Card title</h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 ">
                    <div class="card cardHome">
                        <img src="image/L-ami.jpg" class="card-img-top" alt="...">
                        <div class="card-body cardBorderHome">
                            <h5 class="card-title flex">Card title</h5>
                        </div>
                    </div>
...
<!-- Modal Search -->
    <div class="modal fade" id="btnModalSearch" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Modal connexion -->
    <div class="modal fade" id="btnModalConnect" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label AttributModalinscript">Email</label>
                            <input type="text" class="form-control" id="formGroupExampleInput"
                                placeholder="Entrez votre mail">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label AttributModalinscript">Password</label>
...
<!-- Modal Inscription -->
    <div class="modal fade" id="btnModalInscript" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label AttributModalinscript">Full name</label>
                            <input type="text" class="form-control" id="formGroupExampleInput"
